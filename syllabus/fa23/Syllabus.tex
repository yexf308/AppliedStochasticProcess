...
\textbf{AMAT560 Fall 2023}

\textbf{Introduction to Stochastic Processes I}
...
\textbf{Lectures:} MoWe 10:10AM-11:30AM @ Massry Ctr for Business 209
...
An introduction to applied stochastic processes. Topics include Markov chain, inference on Markov chain, Hidden Markov models, EM algorithm, Monte Carlo methods. I will focus the applications on language models.
...
In addition, the students will practice basic programming skills to use software tools in statistics. The programming language in this course will be Python. 

All latest notebook can be downloaded in https://github.com/yexf308/AppliedStochasticProcess. I will keep updating this git repository as class progresses, so please fetch the update regularly. I will also leave a copy (not most updated) version in Brightspace. 
